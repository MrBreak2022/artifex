                    ...
                    <Col md={5}>
                        <main onContextMenu={handleRightClick}>
                            <Watermark content={"くたばれ、クソ野郎"} gap={[20, 50]}>
                                <Image src={product.image} alt={product.name} onMouseDown={handleMouseDown} fluid />
                            </Watermark>
                        </main>
                    </Col>
                    ...
                    <Col md={3}>
                        <Card>
                            <ListGroup variant='flush'>
                                ...
                                <ListGroup.Item>
                                    <Row>
                                        <Button className='btn-block rounded-pill bg-dark' onClick={addToCartHandler} disabled={product.bidding === false || product.seller === userInfo.username} type='Button'> Add to Cart</Button>
